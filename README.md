# mesa-27.0.1-glib-2.31-ubuntu20.04-linux-wayland-graphics / ubuntu-21.04-hirsute support replace wayland to intel backup restore to wayland | revers video driver
