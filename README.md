...
Ubuntu glibc-2.31 fast wayland для тех кто сидит на олд версии  сожалению разработчики зачем то преследуют дистрибутив пытаясь все переобновить б но не сделать быстрее:
